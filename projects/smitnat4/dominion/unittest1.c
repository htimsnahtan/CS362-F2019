...
int main (int argc, char** argv)	{
	...
	baronCardEffect(&G2, t1choice1, t1player); // call the refactored function with newly created G2
	...
	baronCardEffect(&G4, t2choice1, t1player); // call the refactored function with newly created G2
	...
	baronCardEffect(&G6, t3choice1, t3player); // call the refactored function with newly created G6
	...
	printf("Test completed for baronCardEffect!\n");
	return 0;
}